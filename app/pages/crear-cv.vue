...
useSeoMeta({ title: 'Crear CV - CVLab', description: 'Builder de CV' })
...
<template>
  <div class="min-h-screen bg-background">
    <div class="container mx-auto p-4 md:p-8 lg:px-8 max-w-6xl">
      <h1 class="font-heading text-2xl text-black mb-6">
        Crear CV
      </h1>
      ...
      <div class="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="lg:sticky lg:top-8 lg:self-start">
          <h2 class="text-sm font-medium text-secondary mb-2">
